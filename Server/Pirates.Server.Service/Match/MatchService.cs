namespace Pirates.Server.Service.Match
{
    ...
    using Protocol;
    using Protocol.Match;
    using Protocol.Match.Client;
    using Protocol.Match.Client.Choice;
    using Protocol.Match.Server;
    using Protocol.Match.Server.Choice;
    ...
    internal sealed class MatchService
    {
        ...
        private ChoiceType _getProtocolChoiceType(Domain.Action.Resultant.Enums.ChoiceType choiceType)
        {
            return choiceType switch
            {
                Domain.Action.Resultant.Enums.ChoiceType.Action => ChoiceType.Action,
                Domain.Action.Resultant.Enums.ChoiceType.Player => ChoiceType.Player,
                Domain.Action.Resultant.Enums.ChoiceType.Card => ChoiceType.Card,
