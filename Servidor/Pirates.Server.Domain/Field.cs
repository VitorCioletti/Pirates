namespace Pirates.Server.Domain
{
    ...
    public class Field
    {
        ...
        public List<Card.Card> Protected { get; private set; }
        ...
        public void AddProtected(Card.Card card) => Protected.Add(card);

        public List<Card.Card> GetAllProtected() => Protected.ToList();
        ...
        private void _removeAllProtected()
        {
            ...
            foreach (Card.Card protectedCard in allProtected)
